            ...
            var o = function(t, e) {
                ...
                s = function(e) {
                    for (var a = 0; a < e.length; a++) {
                        ...
                        if(o.parent('li').parent('ul').hasClass('sub-menu'))
                        	o.parent('li').parent('ul').parent('li').remove(n.activeClass);
                    }
                };
                    ...
                    for (var e, r = {
                        ...
                        if (r.top >= c.top && r.top < c.bottom) {
                            ...
                            if (e = f(l, h)) {
                                ...
                                if(e.parent('li').parent('ul').hasClass('sub-menu')){
                                	e.parent('li').parent('ul').parent('li').addClass(n.activeClass);
                                }
